...
/*!50013 DEFINER=`local`@`localhost` SQL SECURITY DEFINER */
...
DELIMITER ;;
CREATE DEFINER=`local`@`localhost` PROCEDURE `AddValidBooking`(in Customer int, in TableNum int, in data datetime, in employee int)
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`local`@`localhost` PROCEDURE `CancelOrder`(in id int)
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`local`@`localhost` PROCEDURE `CheckBooking`(in data datetime, in tableNum int)
begin
	set @a = ifnull((select BookingID from Bookings where Date = data and TableNumber = tableNum limit 1),'empty');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`local`@`localhost` PROCEDURE `GetMaxQuantity`()
